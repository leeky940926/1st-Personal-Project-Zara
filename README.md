...
가장 핵심인 상품의 경우, 상품리스트 조회는 [여성/COLLECTION/코트|트랜치코트](https://www.zara.com/kr/ko/woman-outerwear-l1184.html?v1=1882177) 데이터가 있다는 가정하에 클릭하면 데이터를
어떻게 보내줄지에 대해 생각했습니다.

상품상세페이지는 [LIMITED EDITION 울 코트](https://www.zara.com/kr/ko/limited-edition-%EC%9A%B8-%EC%BD%94%ED%8A%B8-p02038125.html?v1=153554411&v2=1882177) 데이터가 있다는 가정하에 클릭하면
데이터를 어떻게 보내줄지에 대해 생각했습니다.
